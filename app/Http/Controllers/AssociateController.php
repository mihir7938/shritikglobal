...
class AssociateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('associates.index')->with('all_customers', $all_customers)->with('secureLoans', $secureLoans)->with('unsecureLoans', $unsecureLoans)->with('statusCounts', $statusCounts);
    }
    private function customerQuery($request)
    {
        ...
        return $query->where('associateId', Auth::user()->username)->orderBy('doj', 'desc');
    }
    public function getCustomers(Request $request)
    {
                ...
                ->addColumn('action', function ($row) {
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="'.route('associates.customers.edit',$row->id).'">
                                Edit
                            </a>
                            <a class="dropdown-item" href="'.route('associates.customers.delete',$row->id).'">
                                Delete
                            </a>
        ...
        return view('associates.customers')->with('sub_products', $sub_products)->with('customers', $customers);
    }
    ...
    public function addCustomer()
    {
        ...
        return view('associates.add')->with('products', $products)->with('sub_products', $sub_products);
    }
    public function saveCustomer(Request $request)
    {
        ...
        $data['associateId'] = Auth::user()->username;
        ...
        return redirect()->route('associates.customers');
    }
    public function editCustomer(Request $request, $id)
    {
        try{
            ...
            $products = $this->productService->getAllProducts();
            $sub_products = $this->subProductService->getActiveSubProducts();
            return view('associates.edit')->with('customer', $customer)->with('products', $products)->with('sub_products', $sub_products);
        }catch(\Exception $e){
    ...
    public function getStatusLogs($id)
    {
        ...
        return view('associates.status_logs')->with('customer', $customer)->with('logs', $logs);
    }
    public function getBankLogs($id)
    {
        $customer = Customer::findOrFail($id);
        $logs = CustomerBank::where('customer_id', $id)->orderBy('created_at', 'asc')->get();
        return view('associates.bank_logs')->with('customer', $customer)->with('logs', $logs);
    }
}